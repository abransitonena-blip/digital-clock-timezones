"""Salidas de fabricación de la secuenciador de flechas (se ejecuta dentro del contenedor de KiCad 9).

    python3 gen/outputs.py

Crea hardware/flechas-127v/fabricacion/ con:
...
PCB = os.path.join(KI, "Flechas127.kicad_pcb")
SCH = os.path.join(KI, "Flechas127.kicad_sch")
...
def main():
    ...
    # ---- esquema y ERC ----
    run("kicad-cli", "sch", "export", "pdf", "-o", os.path.join(esq, "Flechas127_esquema.pdf"), SCH)
    run("kicad-cli", "sch", "erc", "--severity-all", "-o", os.path.join(rep, "ERC_Flechas127.rpt"), SCH)
    ...
    run("kicad-cli", "sch", "export", "netlist", "-o", os.path.join(esq, "Flechas127.net"), SCH)

    # ---- DRC con paridad ----
    run("kicad-cli", "pcb", "drc", "--schematic-parity", "--severity-all", "-o",
        os.path.join(rep, "DRC_Flechas127.rpt"), PCB)
    ...
    run("kicad-cli", "pcb", "export", "step", "-o", os.path.join(d3, "Flechas127.step"),
